...
export default function SideMenu({ setBackground, board, onWhiteboardToggle, onChatbotToggle }) {
      ...
      {!showBackground && (
        <Paper className={classes.container} elevation={1} variant="outlined">
          ...
          <AddItem
            ...
            handleClick={onWhiteboardToggle}  // Trigger the callback to toggle Whiteboard visibility
            type="background"
            width="310px"
            icon={<MoreHorizIcon style={{ marginRight: '10px' }} />}
          />
          <AddItem
            btnText="Open Chatbot"
            handleClick={onChatbotToggle}  // Trigger the callback to toggle Whiteboard visibility
            type="background"
            width="310px"
            icon={<MoreHorizIcon style={{ marginRight: '10px' }} />}
          />
